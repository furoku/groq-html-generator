...
function buildSystemPrompt(baseHTML) {
  ...
  cachedSystemPrompt = `提供されたプロファイルにとってよみやすくわかりやすいページを企画してください。ベースHTMLをその企画にあわせて大幅に変更し、HTMLだけを出力してください。商品名とカート機能は保持。\n\n--- BASE_HTML_START ---\n${baseHTML}\n--- BASE_HTML_END ---`;
...
export function saveHTML(html, { outputDir = path.join(process.cwd(), 'docs', 'output'), prefix = 'generated-page' } = {}) {
